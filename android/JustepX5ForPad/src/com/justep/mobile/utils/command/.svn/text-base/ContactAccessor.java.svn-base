...
/**
 * 联系人访问器 This abstract class defines SDK-independent API for communication with
...
public abstract class ContactAccessor {
	...
	/**
	 * Create a hash map of what data needs to be populated in the Contact
	 * object
	 * 
	 * @param fields
	 ...
	 * try/catch writing. If the property is not found in the object null will
	 * be returned.
	 * 
	 * @param obj
