...
/**
 * @author 007slm(007slm@163.com) This class implements the HTML5 database
 *         support to work around a bug for Android 3.0 devices. It is not used
 *         for other versions of Android, since HTML5 database is built in to
 *         the browser.
 * 
 *         异步返回的(通过execJs来回调)
 */
public class Storage extends PluginAbstractImpl {
	...
	public void openDatabase(String db, String version, String display_name,
		...
		if (this.path == null) {
			this.path = this.ctx.getApplicationContext()
	...
	public void executeSql(String query, String[] params, String tx_id) {
		try {
			if (isDDL(query)) {
				...
				this.execJS("droiddb.completeQuery('" + tx_id + "', '');");
			} else {
			...
			this.execJS("droiddb.fail('" + ex.getMessage() + "','" + tx_id
					+ "');");
		}
	}
	...
	public void processResults(Cursor cur, String tx_id) {
		...
		this.execJS("droiddb.completeQuery('" + tx_id + "', " + result + ");");
	}
