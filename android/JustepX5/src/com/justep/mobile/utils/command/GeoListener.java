...
/**
 * @author 007slm(007slm@163.com) 地理位置监听类
 * 
 *         异步返回的(通过execJs来回调)
 */
public class GeoListener {
	...
	GeoListener(GeoBroker broker, String id, int time) {
		...
		this.mGps = null;
		this.mNetwork = null;
		this.mLocMan = (LocationManager) broker.ctx
	...
	void success(Location loc) {
		...
		this.broker.execJS("justepApp._geo.success('" + id + "'," + params
				+ ");");
	}
	...
	void fail(int code, String msg) {
		this.broker.execJS("justepApp._geo.fail('" + this.id + "', '" + code
				+ "', '" + msg + "');");
		this.stop();
	}
